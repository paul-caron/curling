...
public:
    ...
    static size_t HeaderCallback(char* buffer, size_t size, size_t nitems, void* userdata) {
        std::string& headerString = *static_cast<std::string*>(userdata);
        headerString.append(buffer, size * nitems);
        return size * nitems;
    }
    ...
    void send() {
        ...
        headers = headerString;          // Store the captured headers
    }
...
private:
    Method method = GET;
    std::string url, args, response, body, headers;
